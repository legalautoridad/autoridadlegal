            ...
            <div className="fixed bottom-0 left-0 right-0 md:hidden z-50 bg-slate-950/95 backdrop-blur-md border-t border-white/10 p-3 shadow-2xl flex justify-center">
                <div className="w-full grid grid-cols-3 gap-2">
                    <a 
                        ...
                        className="py-3.5 rounded-xl bg-prestige-gold hover:bg-[#ffe088] text-trust-navy font-extrabold text-[10px] min-[375px]:text-xs sm:text-sm text-center shadow-lg shadow-prestige-gold/25 flex items-center justify-center gap-1.5 transition-all active:scale-95"
                    ...
                    <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-[10px] min-[375px]:text-xs sm:text-sm text-center shadow-lg shadow-emerald-600/25 flex items-center justify-center gap-1.5 transition-all active:scale-95"
                    ...
                    <a 
                        href="#chat-widget"
                        className="py-3.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-[10px] min-[375px]:text-xs sm:text-sm text-center shadow-lg shadow-blue-600/25 flex items-center justify-center gap-1.5 transition-all active:scale-95"
