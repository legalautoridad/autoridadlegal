        ...
        <main className="min-h-screen bg-slate-900 text-white pb-32">
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50 bg-slate-950/95 backdrop-blur-md border-t border-white/10 p-3 shadow-2xl flex justify-center">
                <div className="w-full max-w-2xl grid grid-cols-2 gap-3">
                    <a 
                        href="tel:+34900000000"
                        className="py-3.5 rounded-xl bg-prestige-gold hover:bg-[#ffe088] text-trust-navy font-extrabold text-[10px] min-[375px]:text-xs sm:text-sm md:text-base text-center shadow-lg shadow-prestige-gold/20 flex items-center justify-center gap-2 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                    ...
                    <a 
                        href={whatsappUrl}
                        className="py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-[10px] min-[375px]:text-xs sm:text-sm md:text-base text-center shadow-lg shadow-emerald-600/20 flex items-center justify-center gap-2 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
